...
type GameTheme struct {
	Corners      GameThemeCorners     `json:"corners"`
	Background   GameThemeBackground  `json:"background"`
	Player       GameThemePlayer      `json:"player"`
	GameMessage  GameThemeGameMessage `json:"gameMessage"`
	Thinking     GameThemeThinking    `json:"thinking"`
	Typography   GameThemeTypography  `json:"typography"`
	StatusEmojis map[string]string    `json:"statusEmojis"`
}
