...
const westernPreset: PresetDefinition = {
  theme: {
    ...
    background: { tint: "warm", animation: "tumbleweed" },
    player: {
      color: "amber",
      indicator: "dot",
      indicatorBlink: false,
...
const desertPreset: PresetDefinition = {
  theme: {
    corners: { style: "arrows", color: "amber" },
    background: { tint: "warm", animation: "sun" },
    player: {
      color: "amber",
      indicator: "chevron",
      indicatorBlink: false,
...
const candyPreset: PresetDefinition = {
  theme: {
    ...
    gameMessage: {
      dropCap: true,
      dropCapColor: "lavender",
      bgColor: "lavenderLight",
      fontColor: "dark",
...
/** Comic - Bold graphic novel style, high contrast, punchy */
const superheroPreset: PresetDefinition = {
  theme: {
    corners: { style: "brackets", color: "slate" },
    background: { tint: "neutral" },
    player: {
      color: "cyan",
      indicator: "chevron",
    ...
    thinking: { text: "Next panel...", style: "dots" },
    typography: { messages: "sans" },
    statusFields: {
      bgColor: "white",
      accentColor: "slate",
...
/** Educational - Professional, clean, focused on learning */
const educationalPreset: PresetDefinition = {
  theme: {
    corners: { style: "none", color: "slate" },
    background: { tint: "neutral" },
    player: {
