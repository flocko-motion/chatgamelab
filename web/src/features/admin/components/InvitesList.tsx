...
export function InvitesList({
  ...
  const {
    ...
    isLoading,
    error,
  } = institutionId ? institutionInvitesQuery : allInvitesQuery;
  ...
  const getInstitutionName = useCallback(
    (instId?: string) => {
      ...
      const institution = institutions.find(
        (org: ObjInstitution) => org.id === instId,
      );
  ...
  const handleRevoke = useCallback(
    (inviteId: string) => {
      modals.openConfirmModal({
        ...
        children: (
          <Text size="sm">{t("admin.invites.revokeConfirm.message")}</Text>
        ),
        labels: {
    ...
    const options: SortOption[] = [
      {
        ...
        label: t("admin.invites.sort.modifiedAt-desc"),
      },
      {
        value: "modifiedAt-asc",
        label: t("admin.invites.sort.modifiedAt-asc"),
      },
      ...
      options.push(
        {
          ...
          label: t("admin.invites.sort.organization-asc"),
        },
        {
          value: "organization-desc",
          label: t("admin.invites.sort.organization-desc"),
        },
      );
    }
    return options;
              ...
              <Card key={invite.id} withBorder padding="sm" radius="md">
                <Stack gap="xs">
                  <Group justify="space-between" wrap="nowrap">
                    ...
                    <Badge
                      size="sm"
                      color={getStatusColor(invite.status || "pending")}
                    >
                  ...
                  <Group justify="space-between" align="center">
                    <Text size="xs" c="dimmed">
                      {getDisplayDate(invite)
                        ? new Date(getDisplayDate(invite)!).toLocaleDateString()
                        : "-"}
                    </Text>
